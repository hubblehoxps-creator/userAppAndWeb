      ...
      builder: (ctx, configModel, _){
        if(!AuthHelper.isManualLoginEnable(configModel) && !AuthHelper.isOtpLoginEnable(configModel)){
          ...
          return CustomPopScopeWidget(child: Scaffold(
            appBar: ResponsiveHelper.isDesktop(context)? const PreferredSize(preferredSize: Size.fromHeight(120), child: WebAppBarWidget()) : (context.canPop()) ? CustomAppBarWidget(title: "") : null,
                    ...
                    SliverFillRemaining(
                      ...
                      child: Center(
                        child: SingleChildScrollView(
                          ...
                          child: _LoginFormWidget(width: width, configModel: configModel),
                        ),
                      ),
                    ),
    ...
    return  Padding(
      ...
      child: Center(child: Container(
        ...
        child: Consumer<AuthProvider>(
          builder: (context, authProvider, child) => Form(key: loginScreenState?._formKeyLogin, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            if(!ResponsiveHelper.isDesktop(context))
            ...
            Selector<AuthProvider, bool>(
              ...
              builder: (context, isNumberLogin, child) {
                return CustomTextFieldWidget(
                  ...
                  countryDialCode: isNumberLogin ? loginScreenState?.countryCode : null,
                  onCountryChanged: (CountryCode value) => loginScreenState?.countryCode = value.dialCode,
            ...
            InkWell(
              onTap: ()=> RouteHelper.getCreateAccount(action: RouteAction.pushReplacement),
